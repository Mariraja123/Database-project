	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		case "Register":
			...
			do {
				...
				roletype = scan.nextLine();
				if(roletype.isEmpty())
				{
					System.out.println("Enter the roletype");
				}
				else if (!roletype.matches("[A-Za-z]{3,}")) {
					System.out.println("Enter atleast 3 character");

				} 

			} while (!roletype.matches("[A-Za-z]{3,}"));
			// Email ID
			...
			Userdetail users = new Userdetail(first_name, cpassword, roletype, email, phoneno);
			us.insert(users);
			break;
